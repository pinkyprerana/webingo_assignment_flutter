...
class NetworkApiService implements BaseApiServices {
  ...
  Future<(dynamic, DioException?)> postApiRequestWithTokenAsForm({
    required String url,
    ...
    try {
      ...
      _dio.options.headers.addAll(headers);
      final returnResponse = await _dio.post(url, data: formData);
  ...
  Future<(dynamic, DioException?)> postApiRequestAsForm({
    required String url,
    required FormData formData,
  }) async {
    try {
  ...
  // @override
  Future<(dynamic, DioException?)> getApiRequestWithTokenWithParams({
    required String url,
    ...
    try {
      ...
      final returnResponse = await _dio.get(
        url,
